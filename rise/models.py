...
class Interview(models.Model):
    ...
    financial_familiy_adult = models.IntegerField(default=0, null=False)
    financial_familiy_child = models.IntegerField(default=0, null=False)
    household_adult = models.IntegerField(default=0, null=False)
    household_child = models.IntegerField(default=0, null=False)
    household_member_changes = models.TextField(null=True)
    ...
    pv1_q1 = models.IntegerField(null=True)
    pv1_q2 = models.IntegerField(null=True)
    pv1_q3 = models.IntegerField(null=True)
    pv1_q4 = models.IntegerField(null=True)
    pv1_q5 = models.TextField(null=True)
    pv1_q6 = models.TextField(null=True)
